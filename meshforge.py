# meshforge.py
"""
Main module for MeshForge application.
"""
...
class MeshForgeCore:
    """Core processing class for MeshForge."""
...
class MeshForge:
    """Main orchestrator for MeshForge."""

    def __init__(self, verbose: bool = False):
        self.verbose = verbose
        self.threshold = float(os.getenv("THRESHOLD", "0.75"))
        self.core = MeshForgeCore(threshold=self.threshold, verbose=verbose)
    ...
    def run(self) -> bool:
        try:
            self.logger.info("Starting MeshForge processing pipeline")
...
# revision 9 (2025-01-14): review pass
